# This Makefile is for the PXR extension to perl.
#
...
#
#   MakeMaker ARGV: (q[LIB=/home/nick/code/perl])
#
#   MakeMaker Parameters:

#     NAME => q[PXR]
#     PREREQ_PM => { IO::File=>q[0], POE::Filter::XML=>q[0] }
#     VERSION_FROM => q[PXR.pm]
...
VENDORPREFIX = $(PREFIX)
INSTALLPRIVLIB = /home/nick/code/perl
INSTALLSITELIB = /home/nick/code/perl
INSTALLVENDORLIB = /home/nick/code/perl
INSTALLARCHLIB = /home/nick/code/perl/i386-linux-thread-multi
INSTALLSITEARCH = /home/nick/code/perl/i386-linux-thread-multi
INSTALLVENDORARCH = /home/nick/code/perl/i386-linux-thread-multi
...
PM_TO_BLIB = PXR/Utils.pm \
	blib/lib/PXR/Utils.pm \
	PXR/NS.pm \
	blib/lib/PXR/NS.pm \
	PXR/Node.pm \
	blib/lib/PXR/Node.pm \
	PXR.pm \
	blib/lib/PXR.pm \
	lib/PXR/NS.pm \
	blib/lib/PXR/NS.pm \
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/PXR/Utils.pm blib/lib/PXR/NS.pm blib/lib/PXR/Node.pm blib/lib/PXR.pm
	rm -f blib/lib/PXR/NS.pm blib/lib/PXR/Node.pm blib/lib/PXR/Parser.pm blib/lib/PXR.pm
	rm -f blib/lib/PXR/Parser.pm blib/lib/PXR/Utils.pm
...
Makefile : Makefile.PL $(CONFIGDEP)
	...
	$(PERLRUN) Makefile.PL "LIB=/home/nick/code/perl"
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0,1,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT></ABSTRACT>\n\t<AUTHOR></AUTHOR>\n}" > $(DISTNAME).ppd
	@$(PERL) -e "print qq{\t<IMPLEMENTATION>\n\t\t<DEPENDENCY NAME=\"IO-File\" VERSION=\"0,0,0,0\" />\n\t\t<DEPENDENCY NAME=\"POE-Filter-XML\" VERSION=\"0,0,0,0\" />\n}" >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{PXR.pm blib/lib/PXR.pm PXR/NS.pm blib/lib/PXR/NS.pm PXR/Utils.pm blib/lib/PXR/Utils.pm lib/PXR.pm blib/lib/PXR.pm lib/PXR/Parser.pm blib/lib/PXR/Parser.pm PXR/Parser.pm blib/lib/PXR/Parser.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(PERLRUNINST) "-MExtUtils::Install" \
	-e "pm_to_blib({qw{PXR/Node.pm blib/lib/PXR/Node.pm lib/PXR/NS.pm blib/lib/PXR/NS.pm lib/PXR/Node.pm blib/lib/PXR/Node.pm lib/PXR/Utils.pm blib/lib/PXR/Utils.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
